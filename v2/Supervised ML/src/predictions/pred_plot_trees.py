...
def plot_and_pred_train(X_train, X_test, y_train, y_test, model, model_path) : 
...
def best_model_pred(X_eval, best_model_path) : 
...
def other_model_pred(X_eval, y_pred_best, other_model_path) : 
